...
path_hpp = os.path.join(sys.argv[1], "Version.hpp")
...
if not os.path.exists(path_hpp):
	with open(path_hpp, "w") as file_handle:
		file_handle.write("// autogenerated file, do not edit\n")
		file_handle.write("#include <cstdint>\n\n")
		file_handle.write("extern const char *ZBNT_VERSION;\n")
		file_handle.write("extern const uint32_t ZBNT_VERSION_INT;\n")
		file_handle.write("extern const uint32_t ZBNT_VERSION_MAJOR;\n")
		file_handle.write("extern const uint32_t ZBNT_VERSION_MINOR;\n")
		file_handle.write("extern const uint32_t ZBNT_VERSION_PATCH;\n")
		file_handle.write("extern const char *ZBNT_VERSION_COMMIT;\n")
		file_handle.write("extern const bool ZBNT_VERSION_DIRTY;\n")
